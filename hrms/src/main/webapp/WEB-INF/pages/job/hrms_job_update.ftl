...
<div class="row">
    <div class="col-12">
        ...
        <h6 class="border-bottom page-title">更新职位</h6>
        <form action="${basePath}/job/update" method="post">
            <div class="form-group form-row">
                <label for="id" class="col-1 col-form-label">职位ID</label>
                <div class="col-4">
                    <input type="text" class="form-control" readonly name="id" id="id" value="${job.id}">
                </div>
                <label for="title" class="col-1 col-form-label">职位名称</label>
                <div class="col-4">
                    <input type="text" class="form-control"  id="title" value="${job.name}" name="name">
                </div>
            </div>
            ...
            <div class="form-group form-row">
                ...
                <div class="col-9">
                    ...
                    <div class="form-control" contenteditable="true"   id="remark">${job.remark}</div>
                </div>
            </div>
            <div class="form-group form-row">
